...
<html lang="zh-cn">
	...
	<body data-target="#one" data-spy="scroll">
		...
		<div class="container" style="padding-bottom: 15px;min-height: 300px; margin-top: 40px;">
							...
							<#list page.list as it>
								<tr>
									...
									<td>
										...
										<i class="glyphicon glyphicon-share-alt"></i><a href="javascript:" id="selectRoleMenu_${it.id}">角色菜单</a>
									</td>
								</tr>
							</#list>
						<#else>
			...
			<#--角色菜单弹框-->
			<div class="modal fade" id="roleTreeDiv" tabindex="-1" role="dialog" aria-labelledby="roleTreeLabel">
		...
		$(document).ready(function(){
			<@shiro.hasPermission name="/role/tragetMTree.shtml">
				var links = $("a[id^='selectRoleMenu_']").each(function(){
					...
					$(this).bind("click", function(){
						$layerIndex = layer.open({
							...
							title : "角色菜单",
							area : [ "50%", "65%" ],
							content : "/role/tragetMTree.shtml?roleId="+roleId,
							scrollbar : false,
							maxmin : true,
							end : function(index) {
							}
